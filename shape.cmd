...
action put #queue clear;var Action clamp when with clamps or a vise to hold it in place|ready to be clamped together|compressed with clamps
	...
	else
	{
		...
		else
		{
			...
			if !contains("$righthandnoun", "drawknife") then
			{
			 ...
			 matchre excess You carefully separate out the excess material
			 matchre work Roundtime: \d+
...
arrowhead_material:
	...
	send get my %1
		...
		match arrowhead_make You carefully
