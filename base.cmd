...
matchre return ^You focus your sense of touch on the energies 
...
matchre return ^You take up a handful of dirt in your palm
matchre return ^As you begin to focus on preparing
matchre return ^Smiling slyly, you murmur the words of
matchre return ^You begin to chant out the
put prepare %todo
goto retry
...
matchre return ^You waggle your fingers at a
...
matchre return ^Invisible strands of
matchre return ^The piercing screech
put cast %todo
goto retry
...
matchre return ^You turn your book
matchre return ^The book is
put turn %todo
goto retry
...
matchre return ^Please rephrase that
put drop %todo
goto retry
...
goto retry
target2:
if $monstercount < 1 then goto return
put face next
goto target1
...
matchre pre.skin ^You'll need a more appropriate weapon to skin with
...
if matchre("$lefthand","(hammer)") then gosub stow my $1 in my ruck
if matchre("$righthand","(hammer)") then gosub stow my $1 in my ruck
...
put exit
pause .5
put #echo >Log1 green  *** Logging out exit.temp***
pause 250
goto reconnect
...
put look
pause 4
put #echo >Log1 green  *** reconnected***
goto Script.begin
