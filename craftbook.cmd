...
#debug 5
var BooksShort \b(bl|we|arm|car|tail)(.+)?
...
BOOK_READ:
	...
	action (ParsePageItem) var ParsePageItem $1 when Instructions for metal (weapon balancing)
	action (ParsePageItem) var ParsePageItem $1 when Instructions for metal (weapon honing)	
...
# add matchtable here
	...
	eval ParsePageItem replacere("%ParsePageItem", "(an?|some|metal|stone|pair of) ", "")
