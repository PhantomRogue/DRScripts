...
var SkipHide Yes
var BowHide No
setvariable weapons bastard sword|crossbow|bastard sword|bola|bola
setvariable WSkill Large_Edged|Crossbow|Twohanded_Edged|Light_Thrown|Small_Blunt
var DEBIL SF.4
var SPELL ec.3
goto goon
...
if $Conviction.LearningRate < 25 then gosub SmiteIt
...
StanceCheck:
if $Parry_Ability.LearningRate < 30 then put stance parr
if $Parry_Ability.LearningRate > 29 then put stance shie
...
ArrangeStuff:
var sCritter $1
if $Skinning.LearningRate > 29 then goto skinit
ArrangeStuff1:
NoBones:
...
pause
FromNecroSkin:
if $First_Aid.LearningRate < 30 then put dissect
else put skin
pause 3
...
if $charactername = Khyric then
{
	if $COURAGE = "OFF" then gosub rebuff COURAGE 8
	if $HES = "OFF" then gosub rebuff HES 5
