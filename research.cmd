...
##					 twice.
## v1.4		:	 Added goto into action watching GAF to force script to restart
##					 current research portion.
##
...
var magics fundamental|Stream|Augmentation|Warding|Utility
...
Check.Research:
	...
	{
		if $Attunement.LearningRate < 20 then goto Do.Research
	}
	if %this.magic = fundamental then
	{
		if ((($Primary_Magic.LearningRate < 18) || ($Arcana.LearningRate < 18)) then
		{
			goto Do.Research
		}
	}
