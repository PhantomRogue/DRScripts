...
ECHO *** TAKING THE FERRY INSTEAD OF Athletics THE FALDESU
ECHO
GOTO MONEYCHECK3
...
ECHO
ECHO
ECHO * * * Now Athletics across the Faldesu River to the port city of Riverhaven, governed by Mayor Bressail 
ECHO
move ne
NSN:
pause
...
ECHO
ECHO ==============================================
ECHO *** You are too burdened to swim the Rossman's route with your current Athletics skill.
...
ECHO *** You need more perception (140+), climbing (100+), or Athletics (140+)
ECHO
...
ECHO
ECHO
ECHO * * * Athletics up the swift-flowing Jantspyre River towards Rossman's Landing
ECHO
...
ECHO ========================================
ECHO *** You cannot take the Rossman's Landing shortcut because you either
ECHO *** Have a group OR need more perception (140+), climbing (100+), or Athletics (30+)
ECHO
ECHO ***  TAKING THE BARGE INSTEAD   ***
ECHO ========================================
ECHO
...
ECHO
ECHO ============================
ECHO *** You don't have enough perception (140), climbing (100), or Athletics (30) to take the shortcut from Rossman's to Riverhaven.
...
ECHO
ECHO
ECHO * * * Athletics down the swift-flowing Jantspyre River towards Riverhaven
...
ECHO
ECHO
ECHO * * * Now Athletics south across the Faldesu River towards the farmlands of southern Therengia
ECHO 
put se
pause
put se
...
CANTSWIM12:
ECHO
ECHO *** You do not have enough Athletics (20) or Strength (16) to pass through Archer's Ford to Boar Clan.  Find someone to drag you or cast some Athletics spells.
ECHO
ECHO * * * If you think this assessment is wrong or you have abnormaly high strength or spells, then you can continue on to Boar Clan by typing GLANCE now.  If you can make it to Boar Clan and back to Hibarnhvidar let me know what your Athletics and strength are (kraelyst@hotmail.com)!
match cont-hib-boa You glance
ECHO
match cont-hib-boa You glance
matchwait
...
CANTSWIM13:
ECHO
ECHO *** You do not have enough Athletics (20) or Strength (16) to pass through Archer's Ford south of Boar Clan.  Find someone to drag you or cast some Athletics spells.
ECHO
