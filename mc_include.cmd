...
location.vars:
	...
	#Crossing Forging
	var CF.room.list 865|902|903|904|905|906|907|908|909|960|961|962|963|6
	var CF.master.room 865|902|903|904|905|906|960|961|962|963
	var CF.smelt.room 903|904|960|961
	var CF.work.room 907|908|909|6
...
#Crossing Engineering
     var CE.room.list 926|927|851|874|925|928|929|930
     var CE.master.room 926|927|851|874|925
...
#Shard Engineering
	...
	#Ratha Engineering
	 ...
	 var RE.master.room 853|854|855|856|857|858|859|860|861|862
...
Ratha.Engineering:
var master Master
var master.room %RE.master.room
var work.room %RE.work.room
var supply.room 858
var part.room 857
var tool.room 854
var repair.room 854 
var repair.clerk Glarstan
var society.type Engineering
return

Shard.Engineering:
var master Master
var master.room %SE.master.room
var work.room %SE.work.room
var supply.room 711
var part.room 718
var tool.room 718
var repair.room 716
