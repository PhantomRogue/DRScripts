...
var LumberDeed $LUMBER_DEED.STOW
...
Chop:
	...
	if %FoundWood = 1 then
		{
		%FoundWood = 0
		if (%volume.track && matchre("$roomobs","%RareMaterialList")) then gosub volume.add rare
		else
			{
...
DangerFailure:
	...
	matchre DangerClear To remind yourself and warn other loggers of the danger, you stack a pile of stones as a warning signal|nothing of concern
